...
const azureConfig = {
    connectionString: 'Endpoint=sb://notificationHubNamespace01.servicebus.windows.net/;SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=4cKGowBBBVe4LmxuCVTmy4QEs8z1XSHqqKG3OWFhcaU=',
    hubName: 'notificationHub01',
}
